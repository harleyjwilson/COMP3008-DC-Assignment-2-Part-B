...
{
    /// <inheritdoc />
    public partial class UpdateTransferDtoModelDescription : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "admin", "Sydney", "email0@gmail.com", "Admin User", "adminpassword", "000-000-0000", "/resources/images/man1.jpg", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "mike", "Northbridge", "email3@gmail.com", "Mike", "mypassword3", "333-333-3333", "/resources/images/man1.jpg", null },
                    { "mistry", "Victoria Park", "email2@gmail.com", "Mistry", "mypassword", "222-222-2222", "/resources/images/man1.jpg", null },
                    { "sajib", "Bently", "email1@gmail.com", "Sajib", "mypassword1", "111-111-1111", "/resources/images/man1.jpg", null }
                });
