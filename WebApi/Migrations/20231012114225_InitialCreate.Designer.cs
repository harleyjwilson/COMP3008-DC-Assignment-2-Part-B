...
namespace WebApi.Migrations
{
    ...
    [Migration("20231012114225_InitialCreate")]
            ...
            modelBuilder.Entity("LocalDBWebApiUsingEF.Models.BankAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AccountNumber = 3,
                            AccountHolderName = "mdltsm plmxazyw's Account",
                            Balance = 7256.5900000000001,
                            UserUsername = "orijb"
                        },
                        new
                        {
                            AccountNumber = 4,
                            AccountHolderName = "nedrrp zogqljog's Account",
                            Balance = 453.30000000000018,
                            UserUsername = "vmbpp"
                        },
                        new
                        {
                            AccountNumber = 5,
                            AccountHolderName = "awmpwl nuqzxwux's Account",
                            Balance = 5650.7099999999991,
                            UserUsername = "sjjbo"
                        },
                        new
                        {
                            AccountNumber = 6,
                            AccountHolderName = "rbzpgf mixaqvmh's Account",
                            Balance = 28841.580000000002,
                            UserUsername = "btdbf"
                        },
                        new
                        {
                            AccountNumber = 7,
                            AccountHolderName = "utokyk uizhyrzh's Account",
                            Balance = 104290.61,
                            UserUsername = "afndp"
                        },
                        new
                        {
                            AccountNumber = 8,
                            AccountHolderName = "gkfatc pkvxixse's Account",
                            Balance = 8112.1700000000001,
                            UserUsername = "kmkno"
                        },
                        new
                        {
                            AccountNumber = 9,
                            AccountHolderName = "xuvpfj jzeuwscw's Account",
                            Balance = 684.63999999999942,
                            UserUsername = "nmhkn"
                        },
                        new
                        {
                            AccountNumber = 10,
                            AccountHolderName = "bnxbcn seucdkrf's Account",
                            Balance = 16863.019999999997,
                            UserUsername = "xkiqt"
                        },
                        new
                        {
                            AccountNumber = 11,
                            AccountHolderName = "qlrtut ecgsqcuf's Account",
                            Balance = 41759.5,
                            UserUsername = "ifybc"
                        },
                        new
                        {
                            AccountNumber = 12,
                            AccountHolderName = "lluyaz zbfqxhjy's Account",
                            Balance = 27185.369999999999,
                            UserUsername = "bpzdr"
                        },
                        new
                        {
                            AccountNumber = 13,
                            AccountHolderName = "zonlkj wqvrmegk's Account",
                            Balance = 13692.290000000001,
                            UserUsername = "ydmaz"
                        },
                        new
                        {
                            AccountNumber = 14,
                            AccountHolderName = "bqskun oirfqsck's Account",
                            Balance = 10033.76,
                            UserUsername = "mjldr"
                        });
                });
            ...
            modelBuilder.Entity("LocalDBWebApiUsingEF.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = 1,
                            Amount = 4642.0,
                            Description = "Transfer of $4,642.00 from 13 to 1",
                            FromAccountNumber = 13,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(779),
                            ToAccountNumber = 1
                        },
                        new
                        {
                            TransactionId = 2,
                            Amount = 2969.0,
                            Description = "Transfer of $2,969.00 from 8 to 14",
                            FromAccountNumber = 8,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(821),
                            ToAccountNumber = 14
                        },
                        new
                        {
                            TransactionId = 3,
                            Amount = 26.0,
                            Description = "Transfer of $26.00 from 11 to 1",
                            FromAccountNumber = 11,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(829),
                            ToAccountNumber = 1
                        },
                        new
                        {
                            TransactionId = 4,
                            Amount = 1841.0,
                            Description = "Transfer of $1,841.00 from 4 to 5",
                            FromAccountNumber = 4,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(833),
                            ToAccountNumber = 5
                        },
                        new
                        {
                            TransactionId = 5,
                            Amount = 619.0,
                            Description = "Transfer of $619.00 from 13 to 8",
                            FromAccountNumber = 13,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(837),
                            ToAccountNumber = 8
                        },
                        new
                        {
                            TransactionId = 6,
                            Amount = 33.0,
                            Description = "Transfer of $33.00 from 11 to 4",
                            FromAccountNumber = 11,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(843),
                            ToAccountNumber = 4
                        },
                        new
                        {
                            TransactionId = 7,
                            Amount = 35120.0,
                            Description = "Transfer of $35,120.00 from 9 to 5",
                            FromAccountNumber = 9,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(846),
                            ToAccountNumber = 5
                        },
                        new
                        {
                            TransactionId = 8,
                            Amount = 1145.0,
                            Description = "Transfer of $1,145.00 from 13 to 12",
                            FromAccountNumber = 13,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(850),
                            ToAccountNumber = 12
                        },
                        new
                        {
                            TransactionId = 9,
                            Amount = 124.0,
                            Description = "Transfer of $124.00 from 3 to 13",
                            FromAccountNumber = 3,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(854),
                            ToAccountNumber = 13
                        },
                        new
                        {
                            TransactionId = 10,
                            Amount = 6652.0,
                            Description = "Transfer of $6,652.00 from 9 to 11",
                            FromAccountNumber = 9,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(859),
                            ToAccountNumber = 11
                        },
                        new
                        {
                            TransactionId = 11,
                            Amount = 1489.0,
                            Description = "Transfer of $1,489.00 from 9 to 12",
                            FromAccountNumber = 9,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(863),
                            ToAccountNumber = 12
                        },
                        new
                        {
                            TransactionId = 12,
                            Amount = 35102.0,
                            Description = "Transfer of $35,102.00 from 10 to 11",
                            FromAccountNumber = 10,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(866),
                            ToAccountNumber = 11
                        },
                        new
                        {
                            TransactionId = 13,
                            Amount = 11773.0,
                            Description = "Transfer of $11,773.00 from 5 to 13",
                            FromAccountNumber = 5,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(870),
                            ToAccountNumber = 13
                        },
                        new
                        {
                            TransactionId = 14,
                            Amount = 18451.0,
                            Description = "Transfer of $18,451.00 from 1 to 7",
                            FromAccountNumber = 1,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(874),
                            ToAccountNumber = 7
                        },
                        new
                        {
                            TransactionId = 15,
                            Amount = 21609.0,
                            Description = "Transfer of $21,609.00 from 5 to 12",
                            FromAccountNumber = 5,
                            Timestamp = new DateTime(2023, 10, 12, 11, 42, 25, 594, DateTimeKind.Utc).AddTicks(878),
                            ToAccountNumber = 12
                        });
                });
            ...
            modelBuilder.Entity("LocalDBWebApiUsingEF.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Username = "orijb",
                            Address = "8691 Oak Ln",
                            Email = "orijb@examplemail.com",
                            Name = "mdltsm plmxazyw",
                            Password = "7729",
                            Phone = "715-841-7379",
